...
if(instance_number(o_textevent)>1 or instance_number(o_textbox)>1){ instance_destroy(); exit; }
...
portrait_frame		= s_portraitframe;
dialogue_box		= s_dialoguebox;
name_box			= s_namebox;
finished_effect		= s_dialoguefinished;
emote_sprite		= s_emotes;

choice_snd_effect	= sfx_moveselect;
select_snd_effect	= sfx_select;
...
finishede_spd	= (sprite_get_speed(s_dialoguefinished)/room_speed);
